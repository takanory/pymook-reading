...
という書籍の読書会イベントについてレポートしていきます。
この書籍は、他のプログラミング言語は知っていて、これからPythonを始める方を対象として、私を含め6人のPythonista(Pythonを使う人)で執筆し、4月17日に技術評論社から発売されました。

この連載では書籍と同様、Pythonの初心者の方を対象と考えています。
Python言語を多少知っている方が、書籍を持っていなくてもこの記事を読んで面白いポイントなどがあることを念頭にレポートしています。

私が、この読書会を始めようと思った動機としては、単純にこの本を読んだ人はどんな人たちで、どんな感想を持っているのか知りたいということ。そして、どのあたりを疑問と思ったのかを知りたいと思ったためです。

読書会の進め方
==============
`第1回の読書会 <http://pymook.connpass.com/event/14008/>`_ は5月21日(木)に `アライドアーキテクツ株式会社 <http://www.aainc.co.jp/>`_ の会議室で開催されました。
当日は以下のタイムテーブルで進めていきました。
